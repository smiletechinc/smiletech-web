      ...
      <Container maxWidth="lg" sx={{ position: "relative", textAlign: "center" }}>
        ...
        <Box sx={{ position: "relative" }}>
          ...
          <Box sx={{ position: "absolute", top: 0 }}>
            <MotionInView variants={varFadeInUp}>
              <img alt="screen" src={`/static/home/theme-color/screen-orange.png`} />
            </MotionInView>
          </Box>
          ...
          <Box sx={{ position: "absolute", top: 0 }}>
            <MotionInView variants={varFadeInDown}>
              ...
              >
                <img alt="sidebar" src={`/static/home/theme-color/block1-orange.png`} />
              </motion.div>
            </MotionInView>
          </Box>
          ...
          <Box sx={{ position: "absolute", top: 0 }}>
            <MotionInView variants={varFadeInDown}>
              <motion.div
                ...
                transition={{ duration: 8, repeat: Infinity }}
              >
                <img alt="sidebar" src={`/static/home/theme-color/block2-orange.png`} />
              </motion.div>
            </MotionInView>
          </Box>
          ...
          <Box sx={{ position: "absolute", top: 0 }}>
            <MotionInView variants={varFadeInDown}>
              ...
              >
                <img alt="sidebar" src={`/static/home/theme-color/sidebar-orange.png`} />
              </motion.div>
            </MotionInView>
          </Box>
        </Box>
